...
export function Sidebar({ collapsed, onToggle, onSignOut }: SidebarProps) {
  ...
  const planClass = plan === "pro"
    ? "text-xs px-2 py-0.5 rounded-full font-semibold bg-blue-400/25 text-blue-200"
              ...
              return (
                <div key="settings-group">
                  ...
                  {settingsOpen && !collapsed && (
                    <div className="ml-3 mt-0.5 border-l border-white/10 pl-2 flex flex-col gap-0">
